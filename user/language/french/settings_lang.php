...
$lang = array(
    ...
    'enable_msm_desc' => 'Si activé, les Super Admins et les membres avec des rôles munis des permissions appropriées pourront gérer des sites web additionnels depuis le <abbr title="Tableau de Bord">TB</abbr>.',
	...
	'system_online_desc' => 'Si désactivé, seuls les Super Admins et les membres munis de rôles associés aux permissions appropriées pourront naviguer sur les sites de cette installation d\'ExpressionEngine. <br> Les réglages individuels <code>Site en ligne?</code> pour les sites MSM peuvent être gérés dans la section <a href="%s">Sites</a> du tableau de bord',
    ...
    'activation_redirect_desc' => 'Chemin (ou route) de modèle auquel rediriger les membres après avoir cliqué un lien d\'activation adressé au sein d'un message email. En cas d\'omission, le message système sera affiché à la place.',
