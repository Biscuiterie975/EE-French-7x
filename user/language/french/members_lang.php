...
$lang = array(
    ...
    'exclude_from_moderation_desc' => 'Si activé, les utilisateurs rattachés à ce groupe pourront commenter sans être affectés par les <a href="%s">réglages de commentaires</a> par défaut.',
    ...
    'lock_description' => 'Seuls les <code>Super Admins</code> peuvent ajouter ou supprimer des membres dans ce rôle.',
    ...
    'member_assignment_warning' => 'Il y actuellement des membres assignés à ce rôle: <b>%d</b> en premier rôle, <b>%d</b> en second.',
    ...
    'member_declined_success_desc' => 'Le membre <b>%s</b> été rejeté.',
   ...
   'role_desc' => 'Affecter des permissions d\'accès à cet utilisateur',
    ...
    'role_highlight_color_desc' => 'Couleur associée au badge de ce rôle. Accepte les codes HEX.',
    ...
    'roles_counter_warning' => 'Le nombre de membres pour chaque rôle peut être imprécis car la configuration <code>ignore_member_stats</code> provoque un écrasement en étant réglée sur <code>y</code>. Merci d\'utiliser l\'utilitaire de statistiques pour recompter.',
    ...
    'no_banned_members_found' => 'Aucun <b>membre censuré</b> n\'a été trouvé.',
    ...
    'no_role_members_found' => 'Aucun <b>membre %</b> trouvé.',
    ...
    'your_password_desc' => 'Vous <b>devez</b> entrer votre mot de passe afin de créer un membre qui puisse avoir accès au tableau de bord.',

    'your_password_anonymize_members_desc' => 'Vous <b>devez</b> entrer votre mot de passe afin de rendre les membres anonymes.',

    'your_password_delete_members_desc' => 'Vous <b>devez</b> entrer votre mot de passe afin de supprimer les membres.',

    'your_password_delete_roles_desc' => 'Vous <b>devez</b> entrer votre mot de passe afin de supprimer les rôles.',
    ...
    'email_banning_instructions' => '<b>Placer chaque adresse email sur une ligne séparée</b><br> partial IP addressesVous pouvez utiliser des adresses IP partielles *',

    'ip_address_banning' => 'Adresses IP',

    'ip_banning_instructions' => '<b>Placer chaque adresse IP sur une ligne séparée</b> <br>Vous pouvez utiliser * comme joker, par exemple. 123.345.*',

    'restrict_to_viewing' => 'Lui limiter l\'accès en mode lecture seule',

    'screen_name_banning' => 'Noms d\'écran censurés',

    'screen_name_banning_instructions' => '<b>Placer chaque nom d\'écran sur une ligne séparée</b><br> Ces noms d\'écran ne seront pas autorisés.',
    ...
    'cp_overview' => 'Aperçu du <abbr title="Tableau de bord">TB</abbr>',
    ...
    'custom_uri' => 'Personnaliser URI &mdash; <i>par exemple members/groups</i>',

    'default_cp_homepage' => 'Page d\'accueil du <abbr title="Tableau de bord">TB</abbr> par défaut',

    'default_cp_homepage_desc' => 'Page d\'accueil du <abbr title="Tableau de bord">TB</abbr> que ce groupe devrait visualiser après s\'être connecté.',
	...
	'show_field_names' => 'Afficher les noms de champs dans Publier',
     ...
     'show_field_names_desc' => 'Si activé, les noms de champs dupliquables seront inclus dans Publication d\'entrées & Edition de pages',
	...
	'edit_member_fields' => 'Editer les champs de membres',
    ...
    'no_cached_email' => 'Aucun <b>message d\'email en cache</b> n\'a été trouvé.',
	...
	'access_overview_can_edit_member_fields' => 'Editer les champs de membres',
