...
$lang = array(
    ...
    'command_sync_conditional_fields_database_info'             => "Base de données: %d requêtes en %f secondes",
	  ...
	  // generate:templates
    'command_generate_templates_summary' => 'Crée des modèles basés sur la structure de données existante',
    'command_generate_templates_description' => 'En utilisant des matrices pré-définies fournies par ExpressionEngine ou par les add-ons, le générateur de modèles produira des modèles prêts à l\'emploi pour votre site.',
    ...
    'command_generate_templates_show_template_content' => 'Affiche les contenus de modèle sans sauvegarde',
    ...
    'command_generate_templates_invalid_generator' => 'Un générateur non valide a été rendu.',
    'separate_choices_commas' => 'Séparez les options multiples par des virgules',
    'command_generate_templates_building_templates' => 'Création de modèles en cours...',
