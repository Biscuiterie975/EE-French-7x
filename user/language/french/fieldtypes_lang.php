...
$lang = array(
	...
	'rel_ft_roles' => 'Rôles à inclure',
     ...
     'rel_ft_roles_desc' => 'Autorise seulement le membre sélectionné avec les rôles initialement choisis',

     'any_role' => 'N\'importe quel rôle',
    ...
    'rel_ft_limit' => 'Nombre maximal des %s disponibles',

    'rel_ft_limit_desc' => 'Fixe le nombre des %s affichées dans le menu déroulant des champs. <br><i>Laisser vide pour autoriser toutes les ‰s.</i>',
    ...
    'rel_ft_order_desc' => 'Classement par défaut des %s dans le champ de relations.',
	...
	'rel_ft_display_member_id' => 'Afficher ls ID de membres?',

     'rel_ft_display_member_id_desc' => 'Si activé, les ID de membres seront affichées ensemble avec le nom d\'écran des membres à l\'intérieur du champ.',
    ...
    'rel_ft_max' => 'Nombre maximum de %s reliées',
    ...
    'rel_ft_min' => 'Nombre minimum de %s reliées',
